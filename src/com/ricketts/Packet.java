...
public abstract class Packet {
    ...
    public Packet(Integer packetId, Integer packetSize, Node sourceNode,
        Node destinationNode, Integer flowId) {
    ...
    public Packet(Integer packetId, Integer packetSize, Flow parentFlow) {
        this(packetId, packetSize, parentFlow.getFlowSource(),
            parentFlow.getFlowDestination(), null); // flow id
    }
    ...
    public Packet(Integer packetId, Integer packetSize, Integer flowId) {
        this(packetId, packetSize, null, null, flowId);
    }
